class ReportComparison
  ...
  def to_json(*a)
    ...
    #  'changed_from_pass'   => changed_from_pass,
    #  'changed_to_fail'     => changed_to_fail,
    #  'changed_to_na'       => changed_to_na,
    #  'fixed_from_fail'     => fixed_from_fail,
    #  'fixed_from_na'       => fixed_from_na,
    #  'regression_to_fail'  => regression_to_fail,
    #  'regression_to_na'    => regression_to_na,
